...
inline const coordinate frontOfRobotDisplacement(0.082, 0.01); // dont use this to tune movement - this must equal the displacement of a block in the grabber arm for positioning
